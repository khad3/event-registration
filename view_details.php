...
<head>
    ...
    <title>View more details by ID</title>
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo ' <a href="remind.php?remind = '.$id.'"><button class="btn btn-warning">Remind</button></a>|<a href="user_view_event.php"><button class="btn btn-primary">Return</button></a>'?></td>
                        </tr>
                        <?php 
                            } 
                        ?>
